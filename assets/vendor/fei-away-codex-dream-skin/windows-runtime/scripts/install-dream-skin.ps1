...
try {
  ...
  if (-not $NoShortcuts) {
    ...
    foreach ($folder in @($desktop, $startMenu)) {
      ...
      $shortcut.Arguments = "-NoProfile -WindowStyle Hidden -ExecutionPolicy RemoteSigned -File `"$startScript`"$portArgument -PromptRestart"
    ...
    $restore.Arguments = "-NoProfile -WindowStyle Hidden -ExecutionPolicy RemoteSigned -File `"$restoreScript`"$portArgument -RestoreBaseTheme -PromptRestart"
