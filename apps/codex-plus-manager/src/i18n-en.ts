...
export const EN_PLAIN: Record<string, string> = {
  ...
  "版本信息、上游源码、日志与诊断": "Version info, upstream source, logs and diagnostics",
  "版本更新": "Version updates",
  "Codework 独立分发版": "Codework standalone distribution",
  "此版本不连接原版更新服务；新版本由 Codework 重新发布安装包。":
    "This build does not connect to the upstream update service. Codework publishes new installers separately.",
  "状态": "Status",
